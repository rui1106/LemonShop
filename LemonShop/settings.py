"""
Django settings for LemonShop project.
...
SECRET_KEY = '4lilzx0ce9n=#hr7(+xd#b9bjunr-z3^4n59l6pj&*$mtj9^iz'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1", "192.168.139.129"]
...
WSGI_APPLICATION = 'LemonShop.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, 'logs/lemonshop.log'),  # 日志文件的位置
